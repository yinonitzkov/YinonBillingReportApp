...
if choose == "Excel Report":
   ...
   ################אלקטרה################################## 
    def ELECTRA_EXCEL(consigneeSelected, Full_path, YEARSelected, monthSelected, ChargeID):   
                        ...
                        HafatzaBeitLakoach_Billing = pd.read_sql_query(f"select * from vCheshbonSapakimMegicBill where year(Date_Aspaka)='{YEARSelected}' and month(Date_Aspaka)='{monthSelected}' and Sochen IN ('11','6') and Mispar_Sapak='300' ", connection)
...
################בוניטה################################## 
    ...
    def BUR_EXCEL(consigneeSelected, Full_path, YEARSelected, monthSelected, ChargeID):
                        ...
                        ExcelFile['ריכוז'] ['B12'] = '=SUM(\'משטחי עץ-יציאה\'!N:N)*16'
